...
const Test = props => {
  ...
  const articleCards = props.articles.map(a => <Card key={a.id} title={a.attributes.title} author={a.attributes.author} summary={a.attributes.summary} tag={a.attributes.tag} />) 
